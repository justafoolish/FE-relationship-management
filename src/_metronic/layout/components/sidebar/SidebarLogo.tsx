    ...
    <div className="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
      <Link to="/dashboard">
        {config.layoutType === 'dark-sidebar' ? (
          ...
          <>
            <img alt="Logo" src={toAbsoluteUrl('/media/logos/default.svg')} className="h-25px app-sidebar-logo-default theme-light-show" />
            <img alt="Logo" src={toAbsoluteUrl('/media/logos/default-dark.svg')} className="h-25px app-sidebar-logo-default theme-dark-show" />
          </>
        )}
