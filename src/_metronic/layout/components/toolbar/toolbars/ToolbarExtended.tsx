      ...
      <div className="d-flex align-items-center flex-shrink-0 me-5">
        ...
        <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Invite a team member">
          <a href="#" className="btn btn-sm btn-icon">
            <KTSVG path="/media/icons/duotune/general/gen035.svg" className="svg-icon-2hx svg-icon-success" />
          </a>
        </div>
      </div>
      {/* end::Button */}
      ...
      <div className="d-flex align-items-center overflow-auto">
        ...
        <div className="d-flex align-items-center">
          <button
            ...
            <KTSVG path="/media/icons/duotune/general/gen025.svg" className="svg-icon-3 svg-icon-primary" />
          </button>

          <button type="button" className="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Enable row view">
            <KTSVG path="/media/icons/duotune/general/gen010.svg" className="svg-icon-3 svg-icon-gray-400" />
          </button>
        </div>
        {/* end::Actions */}
      </div>
