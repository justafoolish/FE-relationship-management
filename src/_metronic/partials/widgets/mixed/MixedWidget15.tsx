      ...
      <div className="row g-0">
          ...
          <div className="d-flex align-items-center mb-9 me-2">
            ...
            <div className="symbol symbol-40px me-3">
              <div className="symbol-label bg-body bg-opacity-50">
                <KTSVG path="/media/icons/duotune/abstract/abs043.svg" className="svg-icon-1 svg-icon-dark" />
              </div>
            </div>
            {/*end::Symbol*/}
        ...
        <div className="col-6">
          <div className="d-flex align-items-center mb-9 ms-2">
            ...
            <div className="symbol symbol-40px me-3">
              <div className="symbol-label bg-body bg-opacity-50">
                <KTSVG path="/media/icons/duotune/abstract/abs046.svg" className="svg-icon-1 svg-icon-dark" />
              </div>
            </div>
            {/*end::Symbol*/}
