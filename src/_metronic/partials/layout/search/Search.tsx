            ...
            <div ref={resultsElement} data-kt-search-element="results" className="d-none">
              <div className="scroll-y mh-200px mh-lg-350px">
                ...
                <a href="/#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/general/gen005.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <a href="/#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/general/gen032.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <a href="/#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/communication/com012.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <a href="/#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/communication/com006.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
            ...
            <div ref={suggestionsElement} className="mb-4" data-kt-search-element="main">
              ...
              <div className="scroll-y mh-200px mh-lg-325px">
                <div className="d-flex align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/electronics/elc004.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <div className="d-flex align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/graphs/gra001.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <div className="d-flex align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/graphs/gra006.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <div className="d-flex align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/graphs/gra002.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <div className="d-flex align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/communication/com010.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
                ...
                <div className="d-flex align-items-center mb-5">
                  <div className="symbol symbol-40px me-4">
                    <span className="symbol-label bg-light">
                      <KTSVG path="/media/icons/duotune/finance/fin001.svg" className="svg-icon-2 svg-icon-primary" />
                    </span>
                  </div>
