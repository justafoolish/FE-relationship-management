  ...
  return (
    <div className="w-100">
      ...
      <div className="mb-10 fv-row">
        <label className="d-flex align-items-center form-label mb-3">
          ...
          <i
            ...
            title="Provide your team size to help us setup your billing"></i>
        </label>
      ...
      <div className="mb-10 fv-row">
        ...
        <Field type="text" className="form-control form-control-lg form-control-solid" name="accountName" />
          ...
          <label className="d-flex flex-stack mb-5 cursor-pointer">
            <span className="d-flex align-items-center me-2">
              ...
              <span className="d-flex flex-column">
                ...
                <span className="fs-6 fw-bold text-gray-400">Use images to enhance your post flow</span>
              </span>
            </span>
          ...
          <label className="d-flex flex-stack mb-0 cursor-pointer">
            <span className="d-flex align-items-center me-2">
              ...
              <span className="d-flex flex-column">
                ...
                <span className="fs-6 fw-bold text-gray-400">Use images to enhance time travel rivers</span>
              </span>
            </span>
