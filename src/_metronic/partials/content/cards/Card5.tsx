    ...
    <div className="card h-100">
      <div className="card-header flex-nowrap border-0 pt-9">
        ...
        <div className="card-toolbar m-0">
          <button
            ...
            <KTSVG path="/media/icons/duotune/general/gen024.svg" className="svg-icon-3 svg-icon-primary" />
          </button>
      ...
      <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
        ...
        <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
          {status === 'up' && <KTSVG path="/media/icons/duotune/arrows/arr007.svg" className="svg-icon-3 me-1 svg-icon-success" />}

          {status === 'down' && <KTSVG path="/media/icons/duotune/arrows/arr006.svg" className="svg-icon-3 me-1 svg-icon-danger" />}
