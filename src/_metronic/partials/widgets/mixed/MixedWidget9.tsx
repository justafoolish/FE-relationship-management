              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-info">
                    <KTSVG path="/media/icons/duotune/art/art007.svg" className="svg-icon-1 svg-icon-info" />
                  </div>
                </div>
                {/* end::Symbol */}
              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-danger">
                    <KTSVG path="/media/icons/duotune/abstract/abs027.svg" className="svg-icon-1 svg-icon-danger" />
                  </div>
                </div>
                {/* end::Symbol */}
              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-success">
                    <KTSVG path="/media/icons/duotune/ecommerce/ecm002.svg" className="svg-icon-1 svg-icon-success" />
                  </div>
                </div>
                {/* end::Symbol */}
              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-primary">
                    <KTSVG path="/media/icons/duotune/ecommerce/ecm010.svg" className="svg-icon-1 svg-icon-primary" />
                  </div>
                </div>
                {/* end::Symbol */}
