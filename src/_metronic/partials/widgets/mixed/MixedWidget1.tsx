          ...
          <div className="d-flex align-items-center mb-6">
            ...
            <div className="d-flex align-items-center flex-wrap w-100">
              ...
              <div className="d-flex align-items-center">
                ...
                <KTSVG path="/media/icons/duotune/arrows/arr066.svg" className="svg-icon-5 svg-icon-success ms-1" />
              </div>
              {/* end::Label */}
            </div>
            {/* end::Description */}
          ...
          <div className="d-flex align-items-center mb-6">
            ...
            <div className="d-flex align-items-center flex-wrap w-100">
              ...
              <div className="d-flex align-items-center">
                ...
                <KTSVG path="/media/icons/duotune/general/gen024.svg" className="svg-icon-5 svg-icon-danger ms-1" />
              </div>
              {/* end::Label */}
            </div>
            {/* end::Description */}
          ...
          <div className="d-flex align-items-center">
            ...
            <div className="d-flex align-items-center flex-wrap w-100">
              ...
              <div className="d-flex align-items-center">
                ...
                <KTSVG path="/media/icons/duotune/arrows/arr065.svg" className="svg-icon-5 svg-icon-danger ms-1" />
              </div>
              {/* end::Label */}
            </div>
            {/* end::Description */}
