...
const TilesWidget3 = ({ className, bgColor = '#663259', title = 'Create SaaS', title2 = 'Based Reports' }: Props) => {
  return (
    <div
      ...
      <div className="card-body d-flex flex-column justify-content-between">
        ...
        <a href="#" className="text-warning fw-semibold">
          Create Report
          <KTSVG className="svg-icon-2 svg-icon-warning" path="/media/icons/duotune/arrows/arr064.svg" />
        </a>
        {/* end::Link */}
      </div>
      {/* end::Body */}
