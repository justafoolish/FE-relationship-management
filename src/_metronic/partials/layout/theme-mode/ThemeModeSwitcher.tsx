  ...
  return (
    <>
      ...
      <a
        ...
        {calculatedMode === 'dark' && (
          <KTSVG path="/media/icons/duotune/general/gen061.svg" className={clsx('theme-light-hide', toggleBtnIconClass)} />
        )}

        {calculatedMode === 'light' && (
          <KTSVG path="/media/icons/duotune/general/gen060.svg" className={clsx('theme-dark-hide', toggleBtnIconClass)} />
        )}
      </a>
      {/* begin::Menu toggle */}
