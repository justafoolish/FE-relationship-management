            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  ...
                  {/* end::Title */}
                  {/* begin::Description */}
                  <div className="text-muted fw-bold fs-7 fs-lg-6">Check out our 300+ in-house components and customized 3rd-party plugins.</div>
                  {/* end::Description */}
                </div>
                {/* end::Wrapper */}
                <KTSVG path="/media/icons/duotune/arrows/arr064.svg" className="svg-icon-gray-400 svg-icon-2" />
            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  ...
                  {/* end::Title */}
                  {/* begin::Description */}
                  <div className="text-muted fw-bold fs-7 fs-lg-6">Latest features and improvements added with our users feedback in mind.</div>
                  {/* end::Description */}
                </div>
                {/* end::Wrapper */}
                <KTSVG path="/media/icons/duotune/arrows/arr064.svg" className="svg-icon-gray-400 svg-icon-2" />
