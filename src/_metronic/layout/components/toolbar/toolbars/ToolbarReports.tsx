      ...
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex align-items-center ms-3">
          <button
            ...
            <KTSVG path="/media/icons/duotune/general/gen025.svg" className="svg-icon-2 svg-icon-primary" />
          </button>
          ...
          <button type="button" className="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Enable row view">
            <KTSVG path="/media/icons/duotune/abstract/abs015.svg" className=" svg-icon-2 svg-icon-gray-400" />
          </button>
        </div>
        {/* end::Actions */}
      </div>
