          ...
          <div className="col-lg-6">
            ...
            <label
              ...
              <span className="d-block fw-bold text-start">
                ...
                <span className="text-gray-400 fw-bold fs-6">If you need more info, please check it out</span>
              </span>
            </label>
          </div>
          ...
          <div className="col-lg-6">
            ...
            <label
              ...
              <span className="d-block fw-bold text-start">
                ...
                <span className="text-gray-400 fw-bold fs-6">Create corporate account to mane users</span>
              </span>
            </label>
          </div>
