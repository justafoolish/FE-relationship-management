                ...
                <td>
                  <div className="symbol symbol-50px me-2">
                    <span className="symbol-label bg-light-info">
                      <KTSVG path="/media/icons/duotune/finance/fin006.svg" className="svg-icon-2x svg-icon-info" />
                    </span>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div className="symbol symbol-50px me-2">
                    <span className="symbol-label bg-light-primary">
                      <KTSVG path="/media/icons/duotune/abstract/abs042.svg" className="svg-icon-2x svg-icon-primar" />
                    </span>
                  </div>
                </td>
                <td>
