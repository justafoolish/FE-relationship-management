                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-success">
                          <KTSVG path="/media/icons/duotune/coding/cod002.svg" className="svg-icon-2x svg-icon-success" />
                        </span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-danger">
                          <KTSVG path="/media/icons/duotune/general/gen024.svg" className="svg-icon-2x svg-icon-danger" />
                        </span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-primary">
                          <KTSVG path="/media/icons/duotune/maps/map004.svg" className="svg-icon-2x svg-icon-primary" />
                        </span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-warning">
                          <KTSVG path="/media/icons/duotune/abstract/abs027.svg" className="svg-icon-2x svg-icon-warning" />
                        </span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-info">
                          <KTSVG path="/media/icons/duotune/art/art007.svg" className="svg-icon-2x svg-icon-info" />
                        </span>
                      </div>
                    </td>
                    <td>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-info">
                          <KTSVG path="/media/icons/duotune/abstract/abs042.svg" className="svg-icon-2x svg-icon-info" />
                        </span>
                      </div>
                    </td>
                    <td>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-success">
                          <KTSVG path="/media/icons/duotune/ecommerce/ecm002.svg" className="svg-icon-2x svg-icon-success" />
                        </span>
                      </div>
                    </td>
                    <td>
